  ...
  return (
    <>
      ...
      >
        ...
        <p>
          Cv App Company built the CvApp app as a Free app. This SERVICE is
          provided by Cv App Company at no cost and is intended for use as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at CvApp unless otherwise
        ...
        <p>
          ...
          including but not limited to contacto cv app. The information that we
        ...
        <p>
          ...
          not hesitate to contact us at contactocvapp@gmail.com.
        </p>{" "}
        <p>
